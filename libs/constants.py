...
SETTING_YOLO_MODEL_PATH = 'yoloModelPath'
SETTING_YOLO_CLASSES_PATH = 'yoloClassesPath'
SETTING_YOLO_CONF = 'yoloConf'
SETTING_YOLO_IMGSZ = 'yoloImgsz'
SETTING_YOLO_SCALE = 'yoloScale'
